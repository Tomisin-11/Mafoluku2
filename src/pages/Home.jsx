            ...
            <div className="h-full grid grid-cols-1 lg:grid-cols-2 items-center">
              <div className="lg:ml-25 lg:mt-15 text-center lg:text-left text-white space-y-5">
                ...
                <div className="flex justify-center lg:justify-start gap-4 pt-6">
                  <NavLink to="/donate" className="px-8 py-3 rounded-full bg-[#003F8C] text-white text-sm font-semibold hover:bg-[#0052B4] transition">
                    {slide.primaryBtn || "Donate"}
                  </NavLink>
                  <NavLink to="/about" className="px-8 py-3 rounded-full border border-white/50 text-white text-sm hover:bg-white hover:text-[#003F8C] transition">
