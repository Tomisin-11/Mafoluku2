  ...
  return (
    <section className="max-w-[1200px] mx-auto py-16 md:py-20 px-4 sm:px-6">
              ...
              {pageEvents.map((event, ei) => (
                <article key={ei} className="group bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
                  ...
                  <div className="p-4 flex flex-col h-full">
                    ...
                    <button className="mt-auto border border-yellow-500 text-yellow-600 rounded-full px-4 py-2 text-[11px] font-semibold hover:bg-yellow-500 hover:text-white transition">JOIN US</button>
                  </div>
                </article>
              ))}
            </div>
      ...
      <div className="mt-60 sm:mt-0 flex flex-col items-center gap-6">
        <button className="w-full sm:w-auto mt-15 lg:mt-12 px-10 py-4 rounded-full bg-[#003F8C] text-white font-semibold text-sm hover:bg-[#0052B4] transition">
          VIEW ALL EVENTS
        </button>
      </div>
    </section>
